...
libuserp *without* perl scripts.

=head1 COPYRIGHT

Copyright (C) 2019 Michael Conrad <mike@nrdvana.net>

Distributed under LGPLv2, see LICENSE
...
system('sed', '-i', '-e', 's/--enable-dev/--disable-dev/', '-e', 's/--enable-debug/--disable-debug/', "$dest_dir/Makefile") == 0
