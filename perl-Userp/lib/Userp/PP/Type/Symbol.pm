package Userp::PP::Type::Symbol;
use Moo;
with 'Userp::PP::Type';

=head1 DESCRIPTION

The Symbol type represents an infinite subset of Unicode strings.  Symbols are not
...
equal if the bytes of their UTF-8 representations are identical.
